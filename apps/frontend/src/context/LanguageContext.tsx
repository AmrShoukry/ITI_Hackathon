...
const translations = {
  en: {
    ...
    pending_listings: 'Pending Listing Approvals',
    ...
    manage_settings: 'Manage Pricing & Deposit Policies',
    role: 'Role',
    ...
    no_pending_listings: 'No listings pending review.',
  },
  ar: {
    // General
    logo: 'تأجير مشترك',
    ...
    view_uploaded_id: 'عرض صورة الهوية المرفوعة',
    no_pending_listings: 'لا توجد عروض قيد المراجعة.',
  },
};
